...
void main() {
  ...
  group('Calculate averages', () {
    ...
    test('Calculate amount of darts thrown in a leg', () {
      expect(matchStatistics.calculateScoresAndDartsPerLeg('1', 1), {501: 12});
    });
    ...
    group('Calculate checkout statistics', () {
